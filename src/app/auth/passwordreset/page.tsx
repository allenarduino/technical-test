                ...
                <div className=' lg:w-[90%] flex flex-col  md:justify-center py-5 w-[90%] max-w-[600px] h-full lg:max-w-[650px]'>
                    <div>
                        ...
                        <div className='text-wrapper w-[95%] min-w-[350px] flex text-start'>
                            <p className='font-[300] lg:text-[18px] '>
                    ...
                    <form>
                        ...
                        <input
                            type='email'
                            className='w-full  rounded-md border-[1px] border-gray-300 py-2 md:py-4 pl-3 text-gray-500 text-[20px] transition hover:bg-opacity-90'
                        />
                        <p className='py-4 text-red-500'>
                            Hmmm. We couldn’t find an account with that email.
                        </p>
