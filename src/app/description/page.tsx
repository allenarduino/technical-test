...
const Description: React.FC<DescriptionProps> = () => {
    return (
        <section className="flex min-h-screen  z-10  border-red-500 border-2 flex-col items-center justify-center w-full">
            ...
            <button
                className="border-[1px] w-[120px]  mt-[100px]  lg:hidden flex justify-center  bg-custom-blue cursor-pointer text-white md:px-10 md:py-3  px-5 py-2 rounded-full font-medium">Continue</button>
