...
const Description: React.FC<DescriptionProps> = () => {
  return (
    <section className='flex min-h-screen  justify-center w-full'>
      <div className='xl-max-w-[1300px] grid lg:grid-cols-2 lg:mt-[200px] mt-[120px] grid-cols-1 w-[90%] gap-4 md:w-[70%] lg:w-[80%] xl:w-[70%] pl-[15px] md:max-w-[1300px]  h-[482px]'>
        <div className='text-wrapper  sm:cols-span-4 flex flex-col lg:text-start text-center justify-center '>
          ...
          <button className='border-[1px] hidden w-[150px] mt-[45px]  lg:flex justify-center  bg-custom-blue cursor-pointer text-white border-blue-200 md:px-10 md:py-3  px-5 py-2 rounded-full font-medium'>
            Continue
          </button>
        </div>
        ...
        <div className='lg:hidden  flex justify-center py-[50px]'>
          <button className='border-[1px] w-[120px] flex justify-center  bg-custom-blue cursor-pointer text-white md:px-10 md:py-3  px-5 py-2 rounded-full font-medium'>
            Continue
          </button>
        </div>
      </div>
