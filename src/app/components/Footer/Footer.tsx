...
const Footer: React.FC<FooterProps> = () => {
    return (
        <footer className=" w-[100%] bottom-0  absolute w-full flex  justify-center items-center flex-col bg-white text-gray-600 py-4 flex flex-wrap justify-between border-t border-gray-200">
